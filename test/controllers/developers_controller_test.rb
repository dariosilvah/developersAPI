...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { age: @developer.age, birthdate: @developer.birthdate, genre: @developer.genre, hobby: @developer.hobby, level_id: @developer.level_id, name: @developer.name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { age: @developer.age, birthdate: @developer.birthdate, genre: @developer.genre, hobby: @developer.hobby, level_id: @developer.level_id, name: @developer.name } }
